...
export const BOOKING_UI_PL: BookingUiCopy = {
  ...
  lead: '4 krótkie kroki. Zaliczkę opłacisz bezpiecznie online — resztę na miejscu, tylko gotówką.',
  ...
  howManyHint:
    'Indywidualne wycieczki — w jednej godzinie startuje jedna grupa. 1 kierowca = 1 quad; pasażer jedzie z tyłu.',
  ...
  total: 'Razem',
  onSite: 'Na miejscu (gotówka)',
  onSiteCashOnly: 'Resztę kwoty płacisz na miejscu przed startem — tylko gotówką.',
  ...
  noTimesDay: 'Brak wolnych godzin na ten dzień.',
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'Online płacisz tylko zaliczkę (BLIK/przelew). Resztę dopłacasz na miejscu przed startem — wyłącznie gotówką. Zaliczka nie podlega zwrotowi.',
    },
    {
      q: 'Wymagania',
  ...
  checkout: {
    ...
    depositNow: 'Zaliczka teraz',
    remainingLabel: 'Do zapłaty na miejscu (gotówka)',
    ...
    restOnSite: 'Resztę ({amount} zł) zapłacisz na miejscu przed startem — tylko gotówką.',
  ...
  thanks: {
    ...
    confirmed: 'Rezerwacja potwierdzona',
    paidHint: 'Zaliczka została opłacona. Resztę przed startem wyprawy zapłacisz na miejscu — tylko gotówką.',
    paidHintEmail: 'Zaliczka została opłacona — potwierdzenie wysłaliśmy na {email}. Resztę przed startem wyprawy zapłacisz na miejscu — tylko gotówką.',
    ...
    remaining: 'Reszta na miejscu (gotówka)',
    fullPrice: 'Cena pełna',
    home: 'Strona główna',
    nextTitle: 'Co dalej?',
    ...
    next4: 'Na miejscu dopłacisz {amount} zł gotówką i dostaniesz briefing.',
...
export const BOOKING_UI_EN: BookingUiCopy = {
  ...
  lead: '4 short steps. Pay the deposit securely online — the rest on site, cash only.',
  ...
  howManyHint:
    'Individual trips — one group per start time. 1 driver = 1 quad; a passenger rides on the back.',
  ...
  total: 'Total',
  onSite: 'On site (cash)',
  onSiteCashOnly: 'Pay the remaining amount on site before the start — cash only.',
  ...
  noTimesDay: 'No free times that day.',
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'Online you pay only the deposit (BLIK/transfer). The rest is paid on site before the start — cash only. The deposit is non-refundable.',
    },
    {
      q: 'Requirements',
  ...
  checkout: {
    ...
    depositNow: 'Deposit now',
    remainingLabel: 'Pay on site (cash)',
    bookingHash: 'Booking #{id}',
    accepted: 'Deposit received. Number #{id}.',
    notFound: 'Booking not found.',
    driversPassengers: '{drivers} drv. / {passengers} pas.',
    backToBooking: 'Back to booking',
    restOnSite: 'You will pay the remaining {amount} zł on site before the start — cash only.',
  ...
  thanks: {
    ...
    confirmed: 'Booking confirmed',
    paidHint: 'The deposit is paid. You will settle the rest on site before the start — cash only.',
    paidHintEmail:
      'The deposit is paid — we sent confirmation to {email}. You will settle the rest on site before the start — cash only.',
    ...
    remaining: 'Remaining on site (cash)',
    fullPrice: 'Full price',
    home: 'Home',
    ...
    next4: 'On site you pay the remaining {amount} zł in cash and get a briefing.',
