    ...
    <section className="bg-forest text-snow overflow-hidden section-pad">
      ...
      <div className="wrap">
        <div className="shead center">
          ...
          <h2 className="text-snow">Co mówią<br/>nasi goście</h2>
          <p className="text-[#E7E1D0]">Ponad 127 opinii z oceną 4.9/5 na Google. Kilka najświeższych poniżej.</p>
        </div>
        
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-[24px]">
          {reviews.map((review) => (
            <div key={review.id} className="bg-[rgba(245,241,231,0.06)] border border-[rgba(245,241,231,0.14)] p-[32px_30px] relative">
              <span className="absolute top-[-14px] left-[30px] font-display text-[80px] text-orange leading-none">&quot;</span>
        ...
        <div className="flex justify-center items-center gap-[14px] mt-[50px] font-label tracking-[0.1em] uppercase text-[13px] text-[#F5F1E7]">
          ...
          Zobacz wszystkie 127 opinii na Google
        </div>
      </div>
    </section>
  );
